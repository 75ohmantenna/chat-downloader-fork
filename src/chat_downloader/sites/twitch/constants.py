...
IRC_PORT = 6697
# Anonymous mobile chat requests only message tags and commands.
IRC_CAP_REQUEST = "CAP REQ :twitch.tv/tags twitch.tv/commands"
# Any PASS value and a justinfan* NICK grants anonymous read-only IRC access.
IRC_ANONYMOUS_PASSWORD = "listen"  # noqa: S105 — APK anonymous placeholder, not a credential
