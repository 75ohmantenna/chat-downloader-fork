...
| Twitch live IRC, typed paid-pin metadata, and current notice groups | `sites/twitch/live_service.py`, `irc_transport.py`, `parsing/`, `remappings.py`, `constants.py` | live-service, transport, current-event fixtures, IRC parser, drift harness tests |
