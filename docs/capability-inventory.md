...
| Twitch GraphQL hashes and bounded document fallbacks, badges, Client-ID | `graphql_client.py`, `constants.py`, `types.py`, `parsing/badges.py` | Twitch client, hash and document fallback coverage, badge-purity tests |
