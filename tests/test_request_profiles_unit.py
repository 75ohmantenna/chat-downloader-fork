...
def test_build_request_profile_headers_merges_and_handles_empty_inputs() -> None:
...
def test_get_next_request_profile_for_youtube_progresses_sequence() -> None:
    ...
    assert get_next_request_profile("youtube_web", site="youtube") == "youtube_android"
    assert get_next_request_profile("youtube_android", site="youtube") == "youtube_ios"
